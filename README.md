...
gfabase load <(gzip -dc test/data/GRCh38-20-0.10b.chr21_chrY.gfa.zst) /tmp/chr21_chrY.gfab --rgfa

# extract subgraph of chrY segments (only) and links between them
gfabase sub /tmp/chr21_chrY.gfab /tmp/chrYonly.gfab --reference chrY:1-999,999,999
gfabase view /tmp/chrYonly.gfab > /tmp/chrYonly.gfa

# extract the entire connected component of chr21
gfabase sub /tmp/chr21_chrY.gfab /tmp/chr21.gfab --reference --connected chr21:1-999,999,999
gfabase view /tmp/chr21.gfab > /tmp/chr21.gfa
```
