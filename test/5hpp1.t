...
$gfabase sub "${TMPDIR}/GRCh38-freeze1.gfab" -o "${TMPDIR}/CR1.gfab" --cutpoints 1 215577
...
$gfabase sub "${TMPDIR}/GRCh38-freeze1.gfab" -o "${TMPDIR}/CR1.3.gfab" --cutpoints 3 215577
...
$gfabase sub "${TMPDIR}/GRCh38-freeze1.gfab" -o "${TMPDIR}/RHD.gfab" --cutpoints 1 --range chr1:25,272,509-25,330,445
